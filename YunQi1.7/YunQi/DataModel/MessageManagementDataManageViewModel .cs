...
{
    //20181220 ---棋
    public class MessageManagementDataManageViewModel
    {
        public List<ReplyMessageManagementDataListviewModel> listReplyMessageManagementDataListviewModel { get; set; }
