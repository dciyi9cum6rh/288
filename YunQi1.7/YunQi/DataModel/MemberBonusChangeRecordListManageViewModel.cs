...
namespace DataModel
{
    //20181217 ---棋  YunQiERP 會員點數異動
    public class MemberBonusChangeRecordListManageViewModel
    {
        public List<MemberBonusChangeRecordListViewModel> listMemberBonusChangeRecordListViewModel { get; set; }
