...
namespace DataModel
{
    public class EmployeeDevelopmentBonusListManageViewModel
    {
        public List<EmployeeDevelopmentBonusListViewModel> listEmployeeDevelopmentBonusListViewModel { get; set; }
