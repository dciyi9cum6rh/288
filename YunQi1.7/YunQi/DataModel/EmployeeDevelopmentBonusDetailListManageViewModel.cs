...
namespace DataModel
{
    public class EmployeeDevelopmentBonusDetailListManageViewModel
    {
        //public MemberListViewModel MemberListViewModel { get; set; }      // 目前會員資料
        public List<EmployeeDevelopmentBonusDetailList> listEmployeeDevelopmentBonusDetailList { get; set; }
