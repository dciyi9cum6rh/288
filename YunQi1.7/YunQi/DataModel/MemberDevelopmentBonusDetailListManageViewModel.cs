...
namespace DataModel
{
    public class MemberDevelopmentBonusDetailListManageViewModel
    {
        //public MemberListViewModel MemberListViewModel { get; set; }      // 目前會員資料
        public List<MemberDevelopmentBonusDetailList> listMemberDevelopmentBonusDetailListViewModel { get; set; }
