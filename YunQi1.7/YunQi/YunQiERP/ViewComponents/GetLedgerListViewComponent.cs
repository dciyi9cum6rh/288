...
{
    [Authorize]
    public class GetLedgerListViewComponent : ViewComponent
    {
        private ISalaryRepository ISR { get; set; }
        private IConfiguration config { get; set; }

        public GetLedgerListViewComponent(IConfiguration configuration, ISalaryRepository SalaryRepository)
        {
