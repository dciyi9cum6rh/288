...
namespace YunQiERP.ViewComponents
{
    //20181203
    [Authorize]
    public class EmployeeDevelopmentBonusListViewComponent : ViewComponent
    {
        private IMemberRepository IMR { get; set; }
        private IProductRepository IPR { get; set; }
        private IConfiguration config { get; set; }

        public EmployeeDevelopmentBonusListViewComponent(IConfiguration configuration, IMemberRepository MemberRepository, IProductRepository ProductRepository)
        {
