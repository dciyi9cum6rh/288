...
namespace YunQiERP.ViewComponents
{
    ...
    public class ProductListViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string ProductCategory = "", string Product = "", int Page = 1, int LinkType = 0, int StartPage = 1, string AClass = "page-link")
        {
            ...
            long memberCount = await IMR.GetProductListCount(ProductCategory, Product);
            ...
            // 9-5系統在ViewComponent【ProductListViewComponent】讀取商品分類清單：
            List<ProductListViewModel> lMLVM = await IMR.GetProductList(ProductCategory, Product, Skip, RowsPerPage);
