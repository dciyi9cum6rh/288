...
{
    [Authorize]
    public class PurchaseDetailListNoButtonViewComponent : ViewComponent
    {
        private IPurchaseRepository IMR { get; set; }
        private IConfiguration config { get; set; }

        public PurchaseDetailListNoButtonViewComponent(IConfiguration configuration, IPurchaseRepository PurchaseRepository)
        {
