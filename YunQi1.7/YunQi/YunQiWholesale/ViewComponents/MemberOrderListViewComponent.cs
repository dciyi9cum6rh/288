...
{
    [Authorize]
    public class MemberOrderListViewComponent : ViewComponent
    {
        private IOrderRepository IMR { get; set; }
        private IConfiguration config { get; set; }

        public MemberOrderListViewComponent(IConfiguration configuration, IOrderRepository OrderRepository)
        {
            IMR = OrderRepository;
        ...
        public async Task<IViewComponentResult> InvokeAsync(string MemberMobile, DateTime? sDate, DateTime? eDate, string Product = "", string OrderId = "", byte OrderStateId = 0, int Page = 1, int LinkType = 0, int StartPage = 1, string AClass = "page-link")
        {
            ...
            // 9-2.系統在ViewComponent【MemberOrderList】讀取我的訂單總數。
            ...
            // 9-5系統在ViewComponent【MemberOrderListViewComponent】讀取我的訂單清單：
            ...
            //listMemberOrderListViewModel=9-5讀取值,
            //CurrentPage=9-6設定值,
            //TotalPages=9-6設定值,
            //PageCount=9-6設定值,
            //StartPage =9-6設定值,
